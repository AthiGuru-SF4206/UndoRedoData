...
export interface IGridOptions {
    ...
    width: string;
    columns: Column[],
    virtualizedColumns: Column[],
    hasDetailTemplate: boolean,
    hasTemplateInEditSettings: boolean,
    ...
    initGroupingField: string[];
    isColumnResized: boolean;
    frozenRightCount: number;
    frozenLeftCount: number;
    frozenLeftColumnsCount: number;
    frozenRightColumnsCount: number;
    frozenName: freezeTable;
    isPreventScrollEvent: boolean;
    isResizedGrid: boolean;
    allowFreezeLineMoving: boolean;
    actualFrozenColumns: number;
    isFreezeLineMoved: boolean;
    isColumnReordered: boolean;
    enableStickyHeader: boolean;
    enableLazyLoading: boolean;
    isColumnWidthChanged: boolean;
    isClipboardEventBinded: boolean;
    tValue: string;
    enableInfiniteScrolling: boolean;
    infiniteMaxBlocks: number;
    infiniteInitialBlock: number;
    infiniteCacheMode: boolean;
    overscanCount: number;
    isRenderedFromTreeGrid: boolean;
    isColumnClipModeChanged: boolean;
    showColumnChooser: boolean;
    autoFit: boolean;
    isFixedColumnPresent: boolean;
    rowRenderingMode: string;
    allowEmptyAreaDrop : boolean;
    customizedOverScan: number;
    isRenderedFromGantt: boolean;
    emptyCellTemplate: boolean;
}

export interface FreezeLineMovingClientOptions {
    columns: Column[];
    frozenColumns: number;
    frozenRightCount: number;
    frozenLeftCount: number;
...
export interface Column {
    ...
    /**
     * Gets the value of the freeze left and right columns width. It is used to updated the frozen column left and right.
     *
     * @default 0
     */
    translateLeftRightValue?: number;
    ...
    /**
     * If `enableSanitization` is set to true, it sanitizes the HTML of the header and content cells.
     *
     * @default true
     */
     ...
     * * Right - It does not freeze the column.
     *
     * @default Left
     */
    freeze: freezeDirection;
    tableWidth: string;
    leftFrozenTableWidth: string;
    rightFrozenTableWidth: string;

    /**
     * Specifies the text to be displayed in a tooltip when a user hovers over the header element.
     * If the `@Description` annotation is present, its value is used as the tooltip text. If not, the header text is used instead.
     *
     * @default null
     */
    description?: string;
...
export type freezeDirection =
    ...
    'Right' |
    /**  freeze the columns at current position */
    'Fixed';
...
export interface FrozenLineOffsetPosition {
    left: number;
    top: number;
    right: number;
}
...
export interface InterSection {
    ...
    overscanCount?: number;
    rowHeight?: number;
    maskRowEnabled?: boolean;
    height?: number;
    viewInfo?: VirtualInfo;
    pageSize?: number;
    previousTop?: number;
    previousLeft?: number;
}
 ...
 * @hidden
 */
export interface InitModulesResults {
    rowHeight: number | null;
    isRowDragCell: boolean | null;
    isMacDevice: boolean | null;
    indentWidth: string | null;
}

/**
 * @hidden
 */
export type FocusEditableCellsArgs = {
    isAdd?: boolean;
    editableCellField?: string | null;
    editableCellFrozenEdit?: boolean;
}
