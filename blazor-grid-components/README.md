...
2. Add Blazor DataGrid component to your Razor page.
...
- [Getting Started with Blazor WebAssembly App](https://blazor.syncfusion.com/documentation/datagrid/getting-started?utm_source=nuget&utm_medium=listing&utm_campaign=blazor-datagrid-nuget)
- [API Reference](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.SfGrid-1.html?utm_source=nuget&utm_medium=listing&utm_campaign=blazor-datagrid-nuget)
